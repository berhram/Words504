...
class LanguagesSaveRepositoryTest {

    private lateinit var repository: LanguagesSaveRepository
    ...
    fun setUp() {
        ...
        repository = LanguagesSaveRepository(cacheDataSource, chosenLanguageCache, domainMapper)
    }
