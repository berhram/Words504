...
class HandleIndexesTest {
    ...
    private lateinit var stringIndexes: HandleIndexes

    @Before
    fun setup() {
        stringIndexes = HandleIndexes.Base()
    }
    ...
    fun test_simple_index_input() {
        ...
        val actual = stringIndexes.handle(input)
    ...
    fun test_indexes_input_with_removing() {
        ...
        val actualInitial = stringIndexes.handle(firstInput)
        ...
        val actualOneLetterRemoved = stringIndexes.handle(removeOneLetter)
        ...
        val actualWithSpaceEnding = stringIndexes.handle(inputWithSpaceEnding)
    ...
    fun test_indexes_input_with_punctuation_marks() {
        ...
        val actual = stringIndexes.handle(sentence)
        Assert.assertEquals(expected, actual)
    }
